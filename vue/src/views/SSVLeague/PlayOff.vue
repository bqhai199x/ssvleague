<template>
  <div class="tw-flex tw-items-center tw-justify-center tw-w-full tw-h-[calc(100vh-50px)] tw-min-w-[1500px]">
    <div class="bracket">
...
.bracket .round .winners>div.matchups label {
  line-height: 3;
  font-size: 1rem;
...
.bracket .round .winners>div.connector .merger:not(.once):before {
  border-right-width: thin;
  border-top-width: thin;
}

.bracket .round .winners>div.connector .merger:not(.once):after {
  border-right-width: thin;
  border-bottom-width: thin;
}

.bracket .round .winners>div.connector .merger.once:before {
  border-bottom-width: thin;
}

.bracket .round.quarterfinals .winners {
  display: flex;
  align-items: center;
  height: 14rem;
}
